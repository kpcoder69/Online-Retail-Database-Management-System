...
ROW_NUMBER() OVER (ORDER BY SUM(o.TotalAmount) DESC) AS rn    --row no. k sath use hota over keyword
FROM Customers c
JOIN Orders o
...
GROUP BY c.CategoryID, c.CategoryName) as sub
WHERE rn = 1;
...
SELECT TOP 1 o.OrderID, o.OrderDate, o.TotalAmount, c.FirstName, c.LastName  -- top 1give recent record
...
--insert customer name in customer coulmn who have nothing purchase....means ORDER is NULL
INSERT INTO Customers(FirstName, LastName, Email, Phone, Address, City, State, ZipCode, Country)
VALUES 
('KARAN', 'PANDEY', 'KARAN.PANDEY@example.com', '9643424291', '123 Elm St.', 'Springfield', 
'IL', '62701', 'USA');
...
SET NOCOUNT ON; -- BY THE HELP OF THIS QUERY WE WILL NOT SEE THE MESSAGE LIKE 1 ROW AFFECTED
